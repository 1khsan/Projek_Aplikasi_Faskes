                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <?php 
                            $hidden = ['idedit'=>$jenis_faskes->id]
                            ?>
                            <?php echo form_open('jenis_faskes/save','',$hidden)?>
                            <div class="form-group row">
                                <label for="nama_faskes" class="col-4 col-form-label">ID</label>
                                <div class="col-8">
                                    <div class="input-group">

                                        <input type="text" name="id" value="<?= $jenis_faskes->id?>" tabindex="-1">
                                        <style type="text/css">
                                        input[name=id] {
                                            pointer-events: none;
                                        }
                                ...
                                <label for="nama_faskes" class="col-4 col-form-label">Nama Faskes</label>
                                <div class="col-8">
                                    <div class="input-group">
                                        ...
                                        <input id="nama_faskes" name="nama_faskes" type="text" required="required"
                                            class="form-control" value="<?= $jenis_faskes->nama?>">
                                    </div>
                                </div>
                            </div>

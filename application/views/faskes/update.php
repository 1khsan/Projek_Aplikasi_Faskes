                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-5">
                                    <textarea id="deskripsi" name="deskripsi" cols="40" rows="3" class="form-control"
                                        value="<?= $faskes->deskripsi ?>"></textarea>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-5">
                                    <div class="input-group">
                                        ...
                                        <input id="skor_rating" name="skor_rating" type="double" max="10" min="0"
                                            class=" form-control" value="<?= $faskes->skor_rating?>">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-5">
                                    <div class="input-group">
                                        ...
                                        <input id="jumlah_dokter" name="jumlah_dokter" type="number"
                                            class="form-control" value="<?= $faskes->jumlah_dokter?>">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-5">
                                    <div class="input-group">
                                        ...
                                        <input id="jumlah_pegawai" name="jumlah_pegawai" type="number"
                                            class="form-control" value="<?= $faskes->jumlah_pegawai?>">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
